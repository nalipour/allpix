...
public:
  ...
  void SetGlobalPosition (G4ThreeVector pxzy) { GlobalPosition = pxzy; }; // nalipour
  void SetLocalPosition (G4ThreeVector pxzy) { LocalPosition = pxzy; }; // nalipour
  ...
  G4ThreeVector GetGlobalPosition() { return GlobalPosition; }; // nalipour
  G4ThreeVector GetLocalPosition() { return LocalPosition; }; // nalipour
...
private:
  ...
  G4ThreeVector GlobalPosition; // nalipour
  G4ThreeVector LocalPosition; // nalipour
